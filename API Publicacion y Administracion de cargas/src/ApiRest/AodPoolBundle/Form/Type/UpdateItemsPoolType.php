...
class UpdateItemsPoolType extends AbstractType 
{ 
           ...
           ->add('csv',TextType::class,
            [
                ...
                'description' => "Archivo CSV con los datos. Puede ser de File (subiendo el archivo) o de tipo TextArea (pegando el texto). 
                                  El CSV ha de estar separado por  ';'. No copiar desde Excel ya que siempre inserta tabulador como elemento separador. Este archivo se usarar para actilizar con dichos datos los triples que correspondan",
            ]
            );
    }
	...
	public function configureOptions(OptionsResolver $resolver)
	{
	    ...
	    $resolver->setDefaults(
            [
                ...
                'data_class' => 'ApiRest\AodPoolBundle\Entity\UpdateItems',
            ]
	    );
	}
}