 ...
 * License: MIT
 * Cambia las coordenasdas en tipo UTM a latitud y logidtud
 * */
	...
	function utm2ll($x,$y,$zone,$aboveEquator){
		...
		return $latlon;//return json_encode(array('success'=>true,'attr'=>array('lat'=>radian2degree($latlon[0]),'lon'=>radian2degree($latlon[1]))));
	}
